...
* TODO Comparable Company Analysis

** features
   - [0/2] Pre downloaded equity csv containing all stock names with industry
     - [ ] India
     - [ ] US
   - [ ] from stock ticker, get the industry
   - [ ] from the industry get all stock ticker of same industry
   - [0/6] from all stock ticker, get
     - [ ] Market Cap
     - [ ] EV
     - [ ] Current Price
     - [ ] P/E
     - [ ] EV/EBITDA
     - [ ] P/B
   - [0/4] Compute following from the above data
     - [ ] mean
     - [ ] median
     - [ ] high
     - [ ] low
   - [0/4] Compute following
     - [ ] most optimistic share valuation
     - [ ] most pesimistic share valuation
     - [ ] mean share valuation
     - [ ] median share valuation


* TODO make a valuation function
